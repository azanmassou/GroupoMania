                        ...
                        <div class="sign-in-from">
                            ...
                            <form class="mt-2" action="{{ route('auth.register') }}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control mb-0 @error('name') is-invalid @enderror" id="name" name="name"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control mb-0 @error('password') is-invalid @enderror" id="email" name="email"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" class="form-control mb-0 @error('password') is-invalid @enderror" id="password" name="password"
