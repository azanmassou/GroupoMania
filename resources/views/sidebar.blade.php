                        ...
                        <div class="tab-content p-0">
                            ...
                            <div class="chart tab-pane active" id="revenue-chart"
                                ...
                                <canvas id="revenue-chart-canvas" height="600"
                                    style="height: 300px; display: block; width: 818px;" width="1636"
                ...
                <div class="card bg-gradient-primary">
                    ...
                    <div class="card-body">
                        <div id="world-map"
                            ...
                            <svg width="818" height="250">
                                <g transform="scale(0.42158516020236086) translate(490.648, 0)">
                                    <path
                ...
                <div class="card bg-gradient-info">
                    ...
                    <div class="card-body">
                        ...
                        <canvas class="chart chartjs-render-monitor" id="line-chart"
                            style="min-height: 250px; height: 250px; max-height: 250px; max-width: 100%; display: block; width: 818px;"
                            width="1636" height="500"></canvas>
                    </div>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td data-action="selectDay" data-day="03/17/2024"
                                                                class="day active today weekend">17</td>
...
<section class="content">
    ...
    <canvas id="areaChart" style="min-height: 250px; height: 250px; max-height: 250px; max-width: 100%; display: block; width: 527px;" width="1054" height="500" class="chartjs-render-monitor"></canvas>
    </div>
    </div>
    ...
    <canvas id="donutChart" style="min-height: 250px; height: 250px; max-height: 250px; max-width: 100%; display: block; width: 527px;" width="1054" height="500" class="chartjs-render-monitor"></canvas>
    </div>
    ...
    <div class="card-body"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
    <canvas id="pieChart" style="min-height: 250px; height: 250px; max-height: 250px; max-width: 100%; display: block; width: 527px;" width="1054" height="500" class="chartjs-render-monitor"></canvas>
    </div>
    ...
    <div class="card-body">
    <div class="chart"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
    <canvas id="lineChart" style="min-height: 250px; height: 250px; max-height: 250px; max-width: 100%; display: block; width: 527px;" width="1054" height="500" class="chartjs-render-monitor"></canvas>
    </div>
    </div>
    ...
    <div class="card-body">
    <div class="chart"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
    <canvas id="barChart" style="min-height: 250px; height: 250px; max-height: 250px; max-width: 100%; display: block; width: 527px;" width="1054" height="500" class="chartjs-render-monitor"></canvas>
    </div>
    </div>
    ...
    <div class="card-body">
    <div class="chart"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
    <canvas id="stackedBarChart" style="min-height: 250px; height: 250px; max-height: 250px; max-width: 100%; display: block; width: 527px;" width="1054" height="500" class="chartjs-render-monitor"></canvas>
    </div>
    </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="card-body">
                                ...
                                <div class="col-md-6" data-select2-id="30">
                                    ...
                                    </select><span class="select2 select2-container select2-container--bootstrap4 select2-container--below" dir="ltr" data-select2-id="24" style="width: 100%;"><span class="selection"><span class="select2-selection select2-selection--multiple" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="-1" aria-disabled="false"><ul class="select2-selection__rendered"><li class="select2-selection__choice" title="Alabama" data-select2-id="63"><span class="select2-selection__choice__remove" role="presentation">×</span>Alabama</li><li class="select2-selection__choice" title="California" data-select2-id="64"><span class="select2-selection__choice__remove" role="presentation">×</span>California</li><li class="select2-search select2-search--inline"><input class="select2-search__field" type="search" tabindex="0" autocomplete="off" autocorrect="off" autocapitalize="none" spellcheck="false" role="searchbox" aria-autocomplete="list" placeholder="" style="width: 0.75em;"></li></ul></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
                                    </div>
                                    ...
                                    <option disabled="disabled" data-select2-id="56">California (disabled)</option>
                                    <option data-select2-id="57">Delaware</option>
                                    <option data-select2-id="58">Tennessee</option>
                                    <option data-select2-id="59">Texas</option>
                                    <option data-select2-id="60">Washington</option>
                                    </select><span class="select2 select2-container select2-container--bootstrap4 select2-container--above" dir="ltr" data-select2-id="26" style="width: 100%;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-disabled="false" aria-labelledby="select2-ki2k-container"><span class="select2-selection__rendered" id="select2-ki2k-container" role="textbox" aria-readonly="true" title="Tennessee">Tennessee</span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
                                    </div>
